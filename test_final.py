...
class SignalProcessor:
    ...
    def scale_reference_signal(self):
     ...
     # Найти пик signal_1_fib в окрестности main_peak_mean
        ...
        scale_factor = max_amplitude_1_fib / mean_signal_shifted[main_peak_mean]  + 0.01
        self.scaled_reference = mean_signal_shifted * scale_factor

    def combine_signals(self):
        self.combined_signal = (self.signal_1_fib + self.scaled_reference) * 0.5
        for i in range (1,10):
            self.combined_signal = (self.combined_signal + self.scaled_reference) * 0.5
    ...
    def analyze_peaks(self, signal, signal_name):
        ...
        peak_widths_result = peak_widths(signal, peak_positions, rel_height=0.9)
    ...
    def plot_signals(self):
        ...
        #Mean Signal
        plt.figure()
        plt.plot(self.mean_signal, label='Mean Signal (Reference)')
